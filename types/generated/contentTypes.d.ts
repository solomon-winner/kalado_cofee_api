...
export interface ApiShipmentMethodShipmentMethod
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::shipment-method.shipment-method'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    price: Schema.Attribute.Decimal &
...
export interface ApiShippmentAddressShippmentAddress
  extends Struct.CollectionTypeSchema {
  collectionName: 'shippment_addresses';
  info: {
    displayName: 'shippmentAddress';
    pluralName: 'shippment-addresses';
